...
Incorrect answers: {}'''.format(
    ...
    frame.ds_size,
    frame.ds_total_time, frame.ds_i_time, frame.ds_c_time,
    frame.ds_total_avgtime, frame.ds_i_avgtime, frame.ds_c_avgtime,
    np.std(np.add(frame.ds_i_arr, frame.ds_c_arr))/1000000000, np.std(frame.ds_i_arr)/1000000000, np.std(frame.ds_c_arr)/1000000000,
    frame.ds_incorrect,
    frame.spark_size,
